...
yosys -p "synth_ecp5 -json build/$1/top.json" -ql build/$1/yosys.log common/defines.v $USER_DEFINES ../rtl/framework.v ../rtl/uart_baud_tick_gen.v ../rtl/uart_rx.v ../rtl/uart_tx.v common/wrapper.v tests/$1/dut.v
